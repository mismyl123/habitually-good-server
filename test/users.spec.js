...
describe('Users Endpoints', function() {
  ...
  describe(`PATCH /api/users`, () => {
    ...
    it(`Gained Points: responds with 200 and updated user points`, () => {
      const updateData = {
        gained_points: 100
      }
      ...
      return supertest(app)
        ...
        .expect(res => {
          ...
          expect(res.body.username).to.eql(testUser.username)
          expect(res.body.first_name).to.eql(testUser.first_name)
          expect(res.body.points).to.eql(testUser.xp + updateData.gained_points)
        ...
        .expect(res =>
          db
            ...
            .then(row => {
              ...
              expect(row.points).to.eql(testUser.points + updateData.gained_points)
            })
        )
    })
    ...
    it(`Gained Points -> Level Up!: responds with 200 and update user points, level, and points_to_next_level`, () => {
      ...
      return supertest(app)
        ...
        .expect(res => {
          ...
          expect(res.body.points).to.eql(testUser.points + updateData.gained_points - testUser.points_to_next_level)
